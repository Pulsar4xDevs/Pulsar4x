...
namespace Pulsar4X.ECSLib
{
    public class StarSystemFactory
    {
        ...
        public StarSystem CreateTestSystem(Game game, int x = 0, int y = 0)
        {
            ...
            PositionDB venusPositionDB = new PositionDB(venusOrbitDB.GetPosition(StaticRefLib.CurrentDateTime), sol.Guid, sun);
            ...
            PositionDB lunaPositionDB = new PositionDB(lunaOrbitDB.GetPosition(StaticRefLib.CurrentDateTime) + planetPositionDB.AbsolutePosition_AU, sol.Guid, planet);
            sensorProfile = new SensorProfileDB();
            ...
            PositionDB halleysPositionDB = new PositionDB(halleysOrbitDB.GetPosition(StaticRefLib.CurrentDateTime), sol.Guid, sun); // + planetPositionDB.AbsolutePosition_AU, sol.ID);
            sensorProfile = new SensorProfileDB();
