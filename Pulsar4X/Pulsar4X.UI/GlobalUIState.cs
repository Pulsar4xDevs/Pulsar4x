...
namespace Pulsar4X.VeldridUI
{
    public class GlobalUIState
    {
        ...
        internal Sdl2Window ViewPort;
        internal (int,int) MainWinSize{get{return (ViewPort.Width, ViewPort.Height);}}
        ...
        internal GlobalUIState(Sdl2Window viewport)
        {
            ViewPort = viewport;
            ...
            uint gltxtrID;
            OpenGLNative.glGenTextures(1, out gltxtrID);
            /*
