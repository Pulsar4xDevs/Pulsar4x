...
{
	[ToolboxItem(true)]
	public class MacGLSurface : DrawingArea, IDisposable
	{
		...
		public MacGLSurface() : this(GraphicsMode.Default) { }

		/// <summary>Constructs a new GLWidget using a given GraphicsMode</summary>
		public MacGLSurface(GraphicsMode graphicsMode) : this(graphicsMode, 1, 0, GraphicsContextFlags.Default) { }

		/// <summary>Constructs a new GLWidget</summary>
		public MacGLSurface(GraphicsMode graphicsMode, int glVersionMajor, int glVersionMinor, GraphicsContextFlags graphicsContextFlags)
		{
