    ...
    internal static class DamageProcessor
    {
        ...
        internal static void SpawnSubAsteroids(Entity Asteroid, DateTime atDateTime)
        {
            ...
            if (ADB.MassDry > massThreshold)
            {
                ...
                Entity newAsteroid1 = AsteroidFactory.CreateAsteroid4(pDB.AbsolutePosition_m, origOrbit, atDateTime, newMass); 
                //var newOrbit = OrbitDB.FromVector(origOrbit.Parent, )
                Entity newAsteroid2 = AsteroidFactory.CreateAsteroid4(pDB.AbsolutePosition_m, origOrbit, atDateTime, newMass);
