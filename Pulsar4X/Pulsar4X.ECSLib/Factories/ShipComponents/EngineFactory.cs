...
#region need to find a way to jsonise this:
        ...
        public static void DataForUI(TechDB factionTechDB, StaticDataStore staticData)
        {
            ...
            double maxEnginePowerMod = TechProcessor.DataFormula(factionTechDB, maxpowerSD);

            Guid minpowertech = new Guid("08fa4c4b-0ddb-4b3a-9190-724d715694de");
            TechSD minpowerSD = staticData.Techs[minpowertech];
            double minEnginePowerMod = TechProcessor.DataFormula(factionTechDB, minpowerSD);
            ...
            double fuelConsumptionBase = TechProcessor.DataFormula(factionTechDB, baseFuelConsumptionSD);
            ...
            double thermalReductionMod = TechProcessor.DataFormula(factionTechDB, thermalReductionSD);
        ...
        public static ComponentSD2 engineasComponentSD()
        {
            ...
            component.CostFormula = new JDictionary<Guid, string> {{new Guid("2d4b2866-aa4a-4b9a-b8aa-755fe509c0b3"), "[Size] * 0.016"}};
