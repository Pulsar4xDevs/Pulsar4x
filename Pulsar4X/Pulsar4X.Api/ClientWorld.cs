...
/// <summary>
/// The client-side replicated world model: a synchronously-readable cache the UI renders from each
...
/// <summary>A single star system within the client world model.</summary>
