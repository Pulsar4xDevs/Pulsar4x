    ...
    public class MoveToNearestAction : EntityCommand
    {
        ...
        private void FindNearestAndSetupWarpCommands()
        {
            ...
            foreach(var ship in ships)
            {
                ...
                (WarpMoveCommand warpCommand, NewtonSimCommand? thrustCommand) = WarpMoveCommand.CreateCommand(cargoLibrary, RequestingFactionGuid, ship, targetEntity, targetPos, EntityCommanding.StarSysDateTime, new Vector3(), shipMass);
